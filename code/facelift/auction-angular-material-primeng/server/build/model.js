...
var Product = (function () {
    function Product(id, title, price, rating, description, categories, image) {
        this.id = id;
        this.title = title;
        this.price = price;
        this.rating = rating;
...
var products = [
    new Product(0, 'First Product', 24.99, 4.3, 'This is a short description. Lorem ipsum dolor sit amet, consectetur adipiscing elit.', ['electronics', 'hardware'], "/images/backpack.png"),
    {
        "id": 1,
